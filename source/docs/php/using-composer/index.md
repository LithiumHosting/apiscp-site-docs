...
Composer is provided with hosting accounts on all [v5+ platforms](/docs/platform/determining-platform-version/). On an older platform? Request a platform migration! This guide covers installing a local copy of Composer on your account.

## Installing

You may download the latest version from its web site using its installation process. Login to the [terminal](/docs/terminal/accessing-terminal/), and run the following command:
